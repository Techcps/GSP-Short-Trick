...
```
curl -LO raw.githubusercontent.com/Techcps/GSP-Short-Trick/master/Developing%20a%20REST%20API%20with%20Go%20and%20Cloud%20Run/techcps761.sh
sudo chmod +x techcps761.sh
./techcps761.sh
```
