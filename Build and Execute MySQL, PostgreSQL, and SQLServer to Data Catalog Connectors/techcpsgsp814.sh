...
gcloud iam service-accounts create sqlserver2dc-credentials --display-name  "Service Account for SQL Server to Data Catalog connector" --project $DEVSHELL_PROJECT_ID

gcloud iam service-accounts keys create "sqlserver2dc-credentials.json" --iam-account "sqlserver2dc-credentials@$DEVSHELL_PROJECT_ID.iam.gserviceaccount.com"

gcloud projects add-iam-policy-binding $DEVSHELL_PROJECT_ID --member "serviceAccount:sqlserver2dc-credentials@$PROJECT_ID.iam.gserviceaccount.com" --quiet --project $DEVSHELL_PROJECT_ID --role "roles/datacatalog.admin"
