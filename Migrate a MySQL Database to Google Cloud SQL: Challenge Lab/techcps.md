...
```
curl -LO raw.githubusercontent.com/Techcps/GSP-Short-Trick/master/Migrate%20a%20MySQL%20Database%20to%20Google%20Cloud%20SQL%3A%20Challenge%20Lab/techcps306.sh
sudo chmod +x techcps306.sh
./techcps306.sh
```
